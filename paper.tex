...
\bottomrule
\multicolumn{5}{l}{$^{1}$ Note: High apparent accuracy in RF is a deceptive result of tabular}\\
\multicolumn{5}{l}{flattening causing severe data-leakage via direct auto-correlation memorization.}\\
\multicolumn{5}{l}{Deep architectures mathematically forbid sequence leakage.}
\end{tabular}
...
\begin{figure}[H]
    ...
    \caption{The integrated Environmental Surveillance Dashboard natively translating Hybrid Deep Learning outputs into actionable, real-time Water Quality Index thresholds and early-warning alerts.}
    \label{fig:dashboard}
\end{figure}
